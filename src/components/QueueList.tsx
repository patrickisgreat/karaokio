    ...
    <div className="space-y-4">
      ...
      {error && (
        <div className="p-3 bg-red-100 text-red-800 rounded-lg border border-red-200">
          {error}
          <button onClick={fetchQueue} className="ml-2 text-red-600 hover:text-red-700 underline">
            Retry
          </button>
        </div>
      )}
          ...
          >
            <div className="flex items-start justify-between">
              <div className="flex items-start space-x-3 flex-1">
                <div
                  className={`w-10 h-10 ${item.user.color} rounded-full flex items-center justify-center text-white font-bold`}
                >
